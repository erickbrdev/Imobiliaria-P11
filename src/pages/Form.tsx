      ...
      <section className="h-screen flex flex-col items-center justify-center bg-yellow-100">
        ...
        >
          <div className="flex flex-col">
            <label htmlFor="name">
              ...
              <input
                ...
                id="name"
                {...register("name")}
                className="w-72 border-yellow-900 border-2 rounded-lg shadow-xl p-1"
              />
            </label>
            {errors.name && (
          ...
          <div className="flex flex-col">
            <label htmlFor="message">
              ...
              <textarea
                cols={30}
                rows={5}
                className="border-2 border-yellow-900 rounded-lg shadow-2xl"
                id="message"
                {...register("message")}
              />
            </label>
          ...
          <div className="flex gap-2 justify-evenly">
            <button
              type="submit"
              className="border-2 border-yellow-900 p-2 rounded-xl font-semibold w-32"
            >
              Enviar
            </button>
            <Link
              to="/"
              type="submit"
              className="border-2 border-yellow-900 p-2 rounded-xl font-semibold w-32 text-center"
            >
              Voltar
            </Link>
          </div>
