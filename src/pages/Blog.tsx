      ...
      <section className="flex flex-col p-3 gap-2 bg-yellow-100 xl:flex-row">
        ...
        <div className="flex-1 flex flex-col gap-5 font-serif font-semibold">
          <div className="flex flex-col justify-center items-center gap-3">
            <h1 className="font-serif border-b-2 border-yellow-400  sm:w-[28rem] text-center text-lg xl:text-xl">
              Como é a sua rotina?
            </h1>
            <p>
          ...
          <div className="flex flex-col justify-center items-center gap-3">
            <h1 className="font-serif border-b-2 border-yellow-400  sm:w-[28rem] text-center text-lg lg:text-xl">
              Seu estilo de vida?
            </h1>
            <p>
